 ...
 * @LastEditTime: 2024-04-17 15:45:27
...
const initPieData = () => {
  ...
  props.baseColor.forEach((item, index) => {
    ...
    legend: {
      ...
      formatter: function (name) {
        ...
        const arr = [
          ...
          `{color${dataIndex % props.baseColor.length}|${((newData[dataIndex].value / Data.pieData.reduce((acc, cur) => acc + cur.value, 0)) * 100).toFixed(2)}%（${

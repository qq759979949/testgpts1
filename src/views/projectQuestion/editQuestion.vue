<template>
  <div class="editQuestion" v-loading="Data.isLoading">
      ...
      <section class="section-container">
        ...
        <section class="section-container">
          <select-user
            ...
            :changeOid="Data.issueOid"
          ></select-user>
        </section>
      </section>
    </div>
    <el-affix target=".editQuestion" position="bottom" :offset="0">
      <div class="actionRow">
...
<script setup name="editQuestion">
...
const Data = reactive({
  ...
  issueOid: that.$route.query.issueOid,
  fileArray: [],

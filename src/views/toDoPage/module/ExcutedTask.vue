 ...
 * @LastEditTime: 2024-04-11 15:12:01
 * @FilePath: \P2023096-PX-SDLG-Frontend\src\views\toDoPage\module\ExcutedTask.vue
 ...
 * @Date: 2024-01-05 08:23:31
 * @LastEditors: wyq ywen@pisx.com
 * @LastEditTime: 2024-03-07 14:39:43
 * @FilePath: \P2023096-PX-SDLG-Frontend\src\views\toDoPage\module\ExcutedTask.vue
 * @Description: 这是默认设置,请设置`customMade`, 打开koroFileHeader查看配置 进行设置: https://github.com/OBKoro1/koro1FileHeader/wiki/%E9%85%8D%E7%BD%AE
-->
<template>
  <div class="custom-item-wrapper">
    ...
    <el-drawer v-model="drawer" title="审核任务" :before-close="handleClose" size="50%" v-if="drawer">
      <PerformTask :oid="oid" ref="performTaskTable" table-name="excutedTaskTable" :operationVal="operationVal" :activeName="activeName"></PerformTask>
    </el-drawer>
  </div>
</template>
...
export default defineComponent({
  ...
  setup(props) {
    ...
    const onSearch = () => {
      that.$refs.excutedTable.searchData(Data.searchValue);
    };
    return {
      ...toRefs(Data),
      appearDrawer,

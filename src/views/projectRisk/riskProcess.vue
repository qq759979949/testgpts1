 ...
 * @LastEditTime: 2024-04-16 15:55:19
...
<template>
  <div class="main-box" v-loading="Data.isLoading">
    ...
    <div class="bottomProcess" :style="{ height: `calc(100vh - ${Data.computedHeight}px)`, overflowY: 'scroll' }">
      <div class="line-title" v-if="Data.workItemName === '解决风险' && !route.query.isCompleted">风险处理</div>
      <div class="sub-box" v-if="Data.workItemName === '解决风险' && !route.query.isCompleted">
...
const getSolutionDetail = () => {
  window.$api.projectRiskApi.queryContentFiles({ oid: Data.riskOid }).then((res) => {
    if (res.success) {

<template>
  <div class="editRisk" v-loading="Data.isLoading">
    <div class="Topping" :style="{ height: `calc(100vh - 340px)`, overflowY: 'scroll' }">
      <div class="topTitle">
        <p class="processName">
      ...
      <section class="section-container">
        ...
        <section class="section-container">
          <select-user ref="selectUserGrading" :parmasObj="Data.parmasObj" v-model:selectUserData="Data.selectUserData" :workitemOid="route.query.workitemOID"></select-user>
        </section>
      </section>
